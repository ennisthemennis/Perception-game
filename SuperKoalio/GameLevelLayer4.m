...
#import "Level4DoneLayer.h"



@interface GameLevelLayer4()
{
    CCTMXTiledMap *map;
    Player * player;
    CCTMXLayer *walls;
...
@end
@implementation GameLevelLayer4
...
+(CCScene *) scene
{
	...
	GameLevelLayer4 *layer = [GameLevelLayer4 node];
...
-(void)gameOver {
	...
	if (won) {
        ...
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"level4complete"];
		[[CCDirector sharedDirector] replaceScene:[Level4DoneLayer scene]];
	} else {
        [[CCDirector sharedDirector] replaceScene:[Level4DieLayer scene]];
		    }
}
-(void)checkForWin {
